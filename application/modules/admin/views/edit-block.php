        ...
        <div class=" card-form">
            <div class="row no-gutters">
                <div class="col-lg-6 card-form__body card-body">
                    <form action="<?php echo base_url(); ?>update_block_master" method="post">
                        <div class="form-group">
                            <input class="form-control" type="hidden" name="id" value="<?php echo $block[0]['id'];?>"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="block_name" value="<?php echo $block[0]['block_name']; ?>"  id="exampleInputEmail1" placeholder="Block Name">
                        </div>
                        <div class="form-group">
                            <label for="exampleFormControlSelect1">Status</label>
                            <select class="form-control" name="status" id="status" required>
                                <option value="">Select Status</option>
                                <option value="1" <?php if ($block[0]['status'] == 1) {echo  "selected";} ?>>Active</option>
                                <option value="2" <?php if ($block[0]['status'] == 2) {echo  "selected";} ?>>Inactive</option>
                            </select>
                        </div>
