...
<div class="mdk-header-layout__content mdk-header-layout__content--fullbleed mdk-header-layout__content--scrollable page"
    ...
    <div class="page__heading border-bottom">
        <div class="container-fluid page__container d-flex align-items-center">
            ...
            <div class="ml-auto d-flex align-items-center">
                <div class="caret-right pull-right"><a href="<?php echo base_url();?>add-block"
                        class="btn btn-primary"><i class="fa fa-plus"></i> Add Block</a></div>
    ...
    <div class="container-fluid page__container">
        ...
        <div class="card card-form mb-3 ">
            <div class="card-body">
                <form action="<?php echo base_url()?>filter_block" method="post" >
                    <div class="row">
                        <div class="col-md-2">
                            <label>
                                <b>
        ...
        <div class="card card-form">
            <table id="example1" class="display nowrap " style="width:100%">
                ...
                <tbody>
                    <?php $i=1; foreach($district_data as $bl){
							$id =$bl['id']; 
							$encoded_id=rtrim(strtr(base64_encode($id ), '+/', '-_'), '=');
							?>
                    <tr>
                        <td><?php echo $i++; ?></td>
                        <!-- <td><?php echo $bl['state_name']; ?></td>
                        <td><?php echo $bl['name']; ?></td> -->
                        <td><?php echo $bl['block_name']; ?></td>
                        <?php if($bl['status']==1){?>
                        ...
                        <?php } ?>
                        <td><a href="<?php echo base_url()?>edit-block/<?php echo $encoded_id ;?>"
