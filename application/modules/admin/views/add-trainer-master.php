        ...
        <div class="card card-form">
            <div class="row no-gutters">
                ...
                <div class="col-lg-12 card-form__body card-body">
                    <form action="<?php echo base_url(); ?>insert_trainer_master" method="post">
                        <div>
                            <div class="form-row">
                                <div class="col-12 col-md-4 mb-3">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Trainer Name</label>
                                        <input type="text" name="trainer_name" class="form-control" id="exampleInputEmail1"
                                ...
                                <div class="col-12 col-md-4 mb-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="trainer_contact" class="form-control"
                                 ...
                                 <div class="col-12 col-md-4 mb-3">
                                        ...
                                        <select class="form-control"name="trainer_gender" id="exampleFormControlSelect1">
