                                ...
                                <div class="col-lg-12 card-form__body card-body">
                                    <form>
                                        ...
                                        <option>Module10</option>
										   ...
										   <div class="col-12 col-md-6 mb-3">
                                        <div class="">
                                             <label for="exampleFormControlSelect1">Select Marks </label>
                                           <select class="form-control" id="exampleFormControlSelect1">
                                          <option>1</option>
                                        <option>2 </option>
										<option>3</option>
                                    ...
                                    <div class="h-150" data-toggle="quill" data-quill-placeholder="Quill WYSIWYG editor" data-quill-modules-toolbar='[["bold", "italic"], ["link", "blockquote", "code", "image"], [{"list": "ordered"}, {"list": "bullet"}]]'>
                                        ...
                                        <p><br></p>
                                            ...
                                            <textarea type="text" class="form-control" id="exampleInputEmail1"></textarea><br>-->
                                        </div>
                                           </div>
											...
											<div class="form-row">
                                                  ...
                                                  <div class="">
                                                   <input class="mt-1 " type="checkbox" class="largerCheckbox" id="vehicle1" name="vehicle1" value="Bike">
                                                  
                                                  </div>
                                                
												 <div class="col-12 col-md-8 mb-3">
                                                  <div class="">
                                                    <input type="text" class="form-control " id="exampleInputEmail1" placeholder=" Option 1">
                                                  </div>
                                                </div>
											...
											<div class="form-row">
                                                  ...
                                                  <div class="">
                                                   <input  class="mt-1" type="checkbox" id="vehicle1" name="vehicle1" value="Bike">
