...
<div class="mdk-header-layout__content mdk-header-layout__content--fullbleed mdk-header-layout__content--scrollable page"
    ...
    <div class="page__heading border-bottom">
        <div class="container-fluid page__container d-flex align-items-center">
            <h5 class="mb-0">Sub Health Center Master</h5>
            <div class="ml-auto d-flex align-items-center">
                <div class="caret-right pull-right"><a href="<?php echo base_url();?>add-sub-sector"
                        class="btn btn-primary"><i class="fa fa-plus"></i> Add Sub-Sector</a></div>
    ...
    <div class="container-fluid page__container">
        <div class="card card-form mb-3 ">
            <div class="card-body">
                <form action="<?php echo base_url()?>filter_sub_sector" method="post">
                    <div class="row">
                        <div class="col-md-2">
                            <label>
                                <b>
        ...
        <div class="card card-form">
            <table id="example1" class="display nowrap " style="width:100%">
                ...
                <tbody>
                    <?php $i=1; foreach($district_data as $ss){
							$sub_id =$ss['sub_id']; 
							$encoded_id=rtrim(strtr(base64_encode($sub_id ), '+/', '-_'), '=');
							?>
                    <tr>
                        <td><?php echo $i++; ?></td>
                        <!-- <td><?php echo $ss['state_name']; ?></td>
                        <td><?php echo $ss['district_name']; ?></td>
                        <td><?php echo $ss['b_name']; ?></td>
                        <td><?php echo $ss['sector_name']; ?></td> -->
                        <td><?php echo $ss['sub_sector_name']; ?></td>
                        <?php if($ss['status']==1){?>
