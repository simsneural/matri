        ...
        <div class="card card-form">
            <div class="row no-gutters">
                ...
                <div class="col-lg-12 card-form__body card-body">
                    <form action="<?php echo base_url(); ?>insert_employee_master" method="post">
                        <div>
                            <div class="form-row">
                                ...
                                <div class="col-12 col-md-4 mb-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="role_name" id="role" required>
                                            ...
                                            <option value="<?php echo $mr['role_id']; ?>">
                                                <?php echo $mr['role_name']; ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-12 col-md-4 mb-3">
                                 ...
                                 <div class="col-12 col-md-4 mb-3">
                                        ...
                                        <select class="form-control"name="emp_gender" id="exampleFormControlSelect1">
