                        ...
                        <div class="card card-form">
                            <div class="row no-gutters">
                                ...
                                <div class="col-lg-12 card-form__body card-body">
                                    <form action="<?php echo base_url(); ?>insert_sector_master" method="post">
                                        <div>
                                            <div class="form-row">
                                       ...
                                       <label for="exampleFormControlSelect1">District Name </label>
                                                ...
                                                <select class="form-control" name="ci_id" id="city_idss">
                                       ...
                                       <select class="form-control" name="block_id" id="block_idss">
                                            ...
                                            <input type="text" name="sector_name" class="form-control" id="exampleInputEmail1" placeholder="Sector Name ">
                                        </div>
                                                </div>
